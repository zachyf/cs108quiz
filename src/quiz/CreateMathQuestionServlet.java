...
/**
 * Servlet implementation class CreateMathQuestionServlet
 */
@WebServlet("/CreateMathQuestionServlet")
public class CreateMathQuestionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateMathQuestionServlet() {
        super();
...
response.setContentType("text/html; charset=UTF-8");
		...
		String question = request.getParameter("mathType");
		String answer = "";
		...
		// Create the question
		Question q = new MathQuestion(question, answer, num);
